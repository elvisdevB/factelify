...
$(function () {
    ...
    $('select[name="id_cliente"]').select2({
        ...
        placeholder: 'Ingrese nombre Clientes',
    ...
    $('#frmCliente').on('submit', function (e) {
        ...
        submit_with_ajax(window.location.pathname, 'Notificación', '¿Estas seguro de crear al cliente?', parameters, function (response) {
    ...
    $('#formAdd').on('submit', function (e) {
        ...
        submit_with_ajax(window.location.pathname, 'Notificación', '¿Estas seguro de realizar la siguiente acción?', parameters, function (response) {
            alert_action('Notificacion','¿Desea imprimir la voleta de venta?', function(){
                window.open('/facturacion/volante/pdf/'+response.id+'/', '_blank')
